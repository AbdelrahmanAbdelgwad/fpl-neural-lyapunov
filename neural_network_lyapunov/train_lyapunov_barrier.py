...
class Trainer:
    ...
    def _save_network(self, iter_count, endFlag_save=False):
        if self.save_network_path:
            if iter_count % self.save_network_iterations == 0 or endFlag_save:
                ...
                elif isinstance(self.lyapunov_hybrid_system.system,
    ...
    def train(self, state_samples_all):
        ...
        while iter_count < self.max_iterations:
            ...
            if iter_count in scheduler_milestones:
                ...
                print("Itern %d: Adam lr %.4f -> %.4f" % (iter_count, before_lr, after_lr))
    ...
    def train_adversarial(self, positivity_state_samples_init: torch.Tensor,
        ...
        while iter_count < self.max_iterations:
            ...
            loss_values.append(lyapunov_positivity_mip_obj+lyapunov_derivative_mip_obj)
