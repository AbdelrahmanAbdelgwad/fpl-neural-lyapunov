...
roa_level,x_sol=get_boundary_levelset(x_lo_larger,x_up_larger,lyapunov_hybrid_system,forward_system,V_lambda, R)
...
plt.tight_layout()
plt.savefig('/home/zw2445/Documents/neural-network-lyapunov/plots/report/pendulum_tedrake_bound'+str(bound_level)+'_traj.png', dpi=300)
# plot lyapunov value
...
plt.rcParams.update({'font.size': 16})
plt.tight_layout()
plt.savefig('/home/zw2445/Documents/neural-network-lyapunov/plots/report/pendulum_tedrake_bound'+str(bound_level)+'_lyap.png', dpi=300)
# %%
