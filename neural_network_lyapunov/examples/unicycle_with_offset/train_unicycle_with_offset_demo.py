...
if __name__ == "__main__":
    ...
    parser.add_argument("--bound_level_last",
                        type=int,default=3,help="bound level of x from pre-trained controller and lyapunov.")       
    args = parser.parse_args()
    args.search_R = True
    args.search_Ru = False
    ...
    if args.bound_level_last>=1:
        ...
        args.load_controller_Ru=dir_path+"/data/tedrake/tedrake_bound"+str(bound_level_last)+"_Ru.pt"
    ...
    if args.train_forward_model:
        ...
        dynamics_model_path = dir_path + "/data/preprocess/forward_model_keepTheta.pt"
    ...
    if args.load_controller_relu:
        ...
        # controller_Ru = torch.load(args.load_controller_Ru)
    ...
    #                                                    dynamics_relu, dt,
    #                                                    thetadot_as_input)
    #UnicycleReLUModel #UnicycleReLUZeroVelModel #UnicycleReLUGivenThetaModel
