...
dt = 0.01
bound_level = 11 # highest level 5 to give largest analysis region
...
def plot_traj(lyapunov_hybrid_system,lyap_func,x_des,x_lo,x_up,N_x=6,dt=0.01,display_violation_states=True):
    ...
    lt.rcParams.update({'font.size': 16})
plt.tight_layout()
plt.savefig('/home/zw2445/Documents/neural-network-lyapunov/plots/report/cart_pole_linf_bound'+str(bound_level)+'_traj.png', dpi=300)
plot_traj(lyapunov_hybrid_system,lyap_func,x_des,x_lo,x_up,N_x=6,dt=0.01,display_violation_states=True)

#%%
print(lyapunov_relu[0].v)
#%%
import gurobipy
