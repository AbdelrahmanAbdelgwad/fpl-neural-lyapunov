...
def path_following_closed_loop_dynamics(plant: cart_pole.Cart_Pole, x: np.ndarray,
                                  controller_relu, x_equilibrium,
                                  u_equilibrium, u_lo, u_up):
    assert (isinstance(plant, cart_pole.Cart_Pole))
...
if __name__ == "__main__":
    ...
    x_lo = torch.tensor([-1*bound_level,-np.pi*bound_level/6,
                         -1.5*bound_level,-1*bound_level], dtype=torch.float64)/200.
    ...
    dynamics_relu = utils.setup_relu((4, 7, 6, 2),
                                      params=None,
                                      negative_slope=0.01,
                                      bias=True,
                                      dtype=torch.float64)
    ...
    V_lambda = 0.8
    controller_relu = utils.setup_relu((4, 5, 4, 1),
                                       params=None,
                                       negative_slope=0.1,
                                       bias=True,
                                       dtype=torch.float64)
    ...
    lyapunov_relu = utils.setup_relu((4, 8, 7, 5, 1),
                                     params=None,
                                     negative_slope=0.1,
                                     bias=True,
                                     dtype=torch.float64)
    ...
    dut.lyapunov_derivative_convergence_tol = 20*1E-6
