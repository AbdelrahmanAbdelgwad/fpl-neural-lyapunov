...
class FPLMonotonicLyapunovTrainer:
    ...
    def compute_fpl_loss(
        ...
        # calculate an fpl for closeness to the goal where it should be closer to the goal than it started relative to horizon steps
        closeness = final_distances - initial_distances / (horizon * decrease_by)
        closeness_fpl = p_mean(
            build_piecewise(
                [(-10.0, 1.0), (-0.1, 0.9), (0.0, 0.01), (0.1, 0.001), (1.0, 0.0)],
                closeness,
                clipped=True,
            ),
            -2.0,
        ...
        control_effort_fpl_batch = p_mean(
            build_piecewise(
                [(0.0, 1.0), (5.0, 0.9), (8.0, 0.5), (15.0, 0.1), (20.0, 0.0)],
                control_effort,
                clipped=True,
            ),
            -2.0,
        ...
        control_effort_fpl = p_mean(control_effort_fpl_batch, -2.0)
