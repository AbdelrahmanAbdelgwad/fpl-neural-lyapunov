...
def plot_lyapunov_contour(x_lo,x_up,x_des,monotonic_NN=None,num_samples=[80,80],V_lambda=0.8,add_l1_state=False,R=None,display_v=False,
                          roa_level=None,mode=None,plot_bLast=False, fig_name=None):
    x_lo_np = x_lo.detach().numpy()
    x_up_np = x_up.detach().numpy()
