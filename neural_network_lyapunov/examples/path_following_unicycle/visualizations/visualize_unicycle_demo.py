...
plt.tight_layout()
plt.savefig('/home/zw2445/Documents/neural-network-lyapunov/plots/report/pf_tedrake_bound'+str(bound_level)+'_traj.png', dpi=300)
# %%
...
plt.rcParams.update({'font.size': 16})
plt.tight_layout()
plt.savefig('/home/zw2445/Documents/neural-network-lyapunov/plots/report/pf_tedrake_bound'+str(bound_level)+'_lyap.png', dpi=300)
# %%
