...
dt = 0.01
bound_level = 15 # highest level 5 to give largest analysis region
...
load_dynamics_relu = dir_path + "data/preprocess/third_order_forward_model2.pt"
