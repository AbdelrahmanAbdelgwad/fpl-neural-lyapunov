...
def path_following_closed_loop_dynamics(plant: path_following.Third_Order_Strict, x: np.ndarray,
                                  controller_relu, x_equilibrium,
                                  u_equilibrium, u_lo, u_up):
    assert (isinstance(plant, path_following.Third_Order_Strict))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bound_level",
                        type=int,default=5,help="bound level of x.")
    ...
    lyapunov_relu = utils.setup_relu((3, 8, 8, 6, 1),
                                     params=None,
                                     negative_slope=0.1,
                                     bias=True,
                                     dtype=torch.float64)
